...
import com.e3hi.geodrop.data.R9AccountPolicy
...
import com.e3hi.geodrop.ui.components.EmptyState
    ...
    TopAppBar(
        ...
        title = {
            TextButton(
                ...
                modifier = Modifier.sizeIn(minHeight = GeoDropSize.minimumTouchTarget)
            ) {
                Column(horizontalAlignment = Alignment.Start) {
                    Text(
                        stringResource(R.string.r4_tab_nearby),
            ...
            Scaffold(
                ...
                Column(
                    ...
                    Button(
                        ...
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(GeoDropSize.minimumTouchTarget)
                    ) {
