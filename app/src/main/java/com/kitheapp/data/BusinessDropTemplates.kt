...
private val GENERAL_BUSINESS_TEMPLATES = listOf(
    ...
    BusinessDropTemplate(
        ...
        contentType = DropContentType.TEXT,
        note = "Thanks for stopping by! Mention code LOCALLOVE at checkout to unlock a loyalty perk just for Kithe explorers.",
        caption = "Unlock a perk just for Kithe fans.",
...
private val BUSINESS_DROP_TEMPLATES: Map<BusinessCategory, List<BusinessDropTemplate>> = mapOf(
    ...
    BusinessCategory.FOOD_TRUCKS_STREET_VENDORS to listOf(
        ...
        BusinessDropTemplate(
            ...
            dropType = DropType.RESTAURANT_COUPON,
            note = "Ask for the 'Kithe bite' and say code STREETFIND for an off-menu sampler while supplies last.",
            caption = "Ask for the Kithe bite."
        )
    ),
    ...
    BusinessCategory.RETAIL_LOCAL_SHOPS to listOf(
        BusinessDropTemplate(
            ...
            dropType = DropType.RESTAURANT_COUPON,
            note = "Kithe exclusive! Say code SHOPLOCAL for 15% off any two items before close tonight.",
    ...
    BusinessCategory.RETAIL_POP_UPS_MARKETS to listOf(
        BusinessDropTemplate(
            ...
            dropType = DropType.COMMUNITY,
            note = "Only 30 jars of today's small-batch jam! Tell us you found the Kithe drop to reserve one while you're here.",
        ...
        BusinessDropTemplate(
            ...
            dropType = DropType.RESTAURANT_COUPON,
            note = "Collect three Kithe codes around the market and say MARKETTRAIL here for a bundle discount.",
    ...
    BusinessCategory.COMMUNITY_NONPROFITS_CENTERS to listOf(
        BusinessDropTemplate(
            ...
            dropType = DropType.COMMUNITY,
            note = "We're preparing weekend care kits. Drop in Saturday at 10am and mention 'Kithe helpers' to join the volunteer crew.",
    ...
    BusinessCategory.COMMUNITY_LIBRARIES_CULTURE to listOf(
        ...
        BusinessDropTemplate(
            ...
            dropType = DropType.COMMUNITY,
            note = "Love this exhibit? Ask a librarian for the Kithe reading list featuring three must-read picks connected to it.",
    ...
    BusinessCategory.MARKETING_LOCAL_GOV_TOURISM to listOf(
        BusinessDropTemplate(
            ...
            dropType = DropType.TOUR_STOP,
            note = "City quest stop! Snap a photo with the sculpture and tag #KitheCity for a chance to win local gift cards.",
