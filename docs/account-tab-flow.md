...
- **Baseline expectation, regardless of specific legal requirements:** most app store review guidelines (and general good practice) expect some self-serve account deletion path to exist, not just "contact us to delete your account." This isn't a Kithe-specific legal question so much as a baseline most published apps meet.
